...
- Para desarrollo local, consumir la API mediante el `API_BASE_URL` configurado y el proxy Angular existente (`/backend` hacia `http://localhost:5089`); no codificar hosts ni puertos en componentes, casos de uso o repositorios.
