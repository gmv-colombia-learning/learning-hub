...
namespace VirtualBuddy.Migrations.SqlServer.Migrations
{
    ...
    public partial class InitialAzureSql : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionVersion = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedAI = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InformationAI = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArchitectureInfo = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(
                ...
                (
                    ...
                    CONSTRAINT [FK_KnowledgeChunks_Projects_ProjectId]
                        FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[Projects] ([Id]) ON DELETE CASCADE
                );
                CREATE INDEX [IX_KnowledgeChunks_ProjectId]
                    ON [dbo].[KnowledgeChunks] ([ProjectId]);
                """);
        }
        ...
        {
            migrationBuilder.Sql("DROP TABLE [dbo].[KnowledgeChunks];");
