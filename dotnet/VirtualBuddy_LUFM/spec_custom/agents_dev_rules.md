...
- No implementar comportamiento fuera de la spec activa.
...
- No implementar una spec incompleta.
- No implementar una spec con estado DRAFT.
- Una spec debe estar READY antes de implementar.
